            ...
            <div className="container-custom py-16">
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-400 leading-7 text-sm max-w-xs mb-6">
                            The calm,powerfull workspace for teams that want to focus for teams that want to focus on work -not on managing it.
                        </p>
                        <div className="flex gap-3">
                            {["twitter","linkedin","github","youtube"].map(platform=>(
                                <div key={platform}className="w-10 h-10 rounded-lg border border-gray-700 flex items-center justify-center text-gray-500 hover:border-teal-700 hover:text-teal-300 transition-all">
                                    <RiTwitterXFill />
                                <TbBrandLinkedin /><FaYoutube /><IoLogoTiktok /></div>
                            ))}
                        </div>
                    ...
                    <ul className="space-y-3">
                            ...
                            <li className="text-gray-400 text-sm hover:text-gray-400 text-sm hover:text-white transition-colors cursor-pointer">Mobile App</li>
                            <li className="text-gray-400 text-sm hover:text-gray-400 text-sm hover:text-white transition-colors cursor-pointer">Pricing</li>
                            <li className="text-gray-400 text-sm hover:text-gray-400 text-sm hover:text-white transition-colors cursor-pointer">Integrations</li>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                            ...
                            <li className="text-gray-400 text-sm hover:text-white transition-colors cursor-pointer">Press</li>
                            <li className="text-gray-400 text-sm hover:text-white transition-colors cursor-pointer">Status</li>
                        </ul>
                </div>
                <div>
                    <h3 className="text-xs font-semibold tracking-wider text-gray-500 uppercase mb-6">Support</h3>
                    <ul className="space-y-3">
