...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "For teams larger than 20 people, we offer custom Enterprise pricing with volume discounts."
    },
    {
    ...
    },
    {
      ...
      answer: "It means our service is available 99.9% of the time, excluding scheduled maintenance. We provide credits if we fail to meet this."
    },
    {
      question: "Is my data secure?",
      answer: "Yes! We're SOC 2 compliant, encrypt data at rest and in transit, and undergo regular security audits."
    },
    {
          ...
          <div className="space-y-0">
            {faqs.map((faq, index) => (
              <div key={index} className="py-6 border-b border-gray-200">
                ...
                {openIndex === index && (
                  <p className="mt-4 text-gray-600 text-sm leading-7">{faq.answer}</p>
                )}
              </div>
            ))}
          </div>
