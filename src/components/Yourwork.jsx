  ...
  return (
    <section className="container-custom py-20 grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        <div className="absolute top-4 right-4 bg-teal-700 text-white px-5 py-3 rounded-2xl shadow-xl">
          <h3 className="text-xl font-bold">34%</h3>
          <p className="text-xs">Output this week</p>
        </div>
        <div className="absolute bottom-4 left-8 bg-white p-4 rounded-2xl shadow-lg border">
