...
const Workflow = () => {
  return (
    ...
    <section className="container-custom py-28">
        ...
        <div className="absolute top-20 right-20 w-72 h-72 bg-teal-600/20 rounded-full blur-3xl"></div>
            ...
            <div className="text-center lg:text-left">
                ...
                <div className="w-1.5 h-1.5 bg-teal-300 rounded-full"></div>
                   ...
                   <p className="text-gray-400 max-w-md mb-8">
                    Join 50,000+ teams who replaced chaos with clarity.Set up in under 10 minutes.</p>
                    </div>
